...
import sys
import configparser
from .utils import _setup_petsc_options, write_out_mesh, _assemble_petsc_system, _solve_linear_problem
...
def import_mesh(arg):
	...
	.xdmf with the command line function mesh-convert (see cashocs main documentation).
