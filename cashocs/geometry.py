...
def import_mesh(arg):
	...
	end_time = time.time()
	info('Done importing mesh. Elapsed time: ' + format(end_time - start_time, '.2f') + ' s')
	info('Mesh contains ' + format(mesh.num_vertices(), ',') + ' vertices and ' + format(mesh.num_cells(), ',') + ' cells of type ' + mesh.ufl_cell().cellname() + '\n')
