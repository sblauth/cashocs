...
from .utils import _setup_petsc_options
...
def damped_newton_solve(F, u, bcs, rtol=1e-10, atol=1e-10, max_iter=50, convergence_type='combined', norm_type='l2',
	...
	while res > tol and iterations < max_iter:
		...
		if breakdown:
			raise Exception('Damped Newton Solver Breakdown')

		if iterations == max_iter:
			raise Exception('Newton Solver exceeded maximum number of iterations.')
