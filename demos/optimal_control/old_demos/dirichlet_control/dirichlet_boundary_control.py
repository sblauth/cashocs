...
optimization_problem = OptimalControlProblem(e, bcs, J, y, u, p, config, riesz_scalar_products=scalar_product, control_constraints=control_constraints)
