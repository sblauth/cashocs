...
volume_initial = 4*6 - assemble(1*dx)
barycenter_x_initial = (1/2*(3**2 - 3**2)*4 - assemble(x[0]*dx)) / volume_initial
barycenter_y_initial = (1/2*(2**2 - 2**2)*6 - assemble(x[1]*dx)) / volume_initial
...
volume = 4*6 - assemble(1*dx)
barycenter_x = (1/2*(3**2 - 3**2)*4 - assemble(x[0]*dx)) / volume
barycenter_y = (1/2*(2**2 - 2**2)*6 - assemble(x[1]*dx)) / volume
